        ...
        <?php if ($action === 'add' || $action === 'edit'): ?>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <form method="POST" action="">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="location"
                                   ...
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-primary focus:border-primary"
                                   placeholder="e.g., South Cotabato, Philippines">
                        ...
                        <div>
                            ...
                            <input type="url" name="image_url"
                                   value="<?php echo htmlspecialchars($edit_case['image_url'] ?? ''); ?>"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-primary focus:border-primary"
                                   placeholder="https://example.com/image.jpg">
                            <p class="text-xs text-gray-400 mt-1">Image for the case study card.</p>
                        </div>
                    ...
                    <div class="mt-6">
                        ...
                        <textarea name="challenge" id="challenge" rows="5"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-primary focus:border-primary"><?php echo htmlspecialchars_decode($edit_case['challenge'] ?? '', ENT_QUOTES); ?></textarea>
                        <p class="text-xs text-gray-400 mt-1">What problem was the client facing? Rich text supported.</p>
                    </div>

                    <div class="mt-6">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Solution</label>
                        <textarea name="solution" id="solution" rows="5"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-primary focus:border-primary"><?php echo htmlspecialchars_decode($edit_case['solution'] ?? '', ENT_QUOTES); ?></textarea>
                        <p class="text-xs text-gray-400 mt-1">How did Tupi Supreme solve the problem? Rich text supported.</p>
                    </div>

                    <div class="mt-6">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Results</label>
                        <textarea name="results" id="results" rows="5"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-primary focus:border-primary"><?php echo htmlspecialchars_decode($edit_case['results'] ?? '', ENT_QUOTES); ?></textarea>
                        <p class="text-xs text-gray-400 mt-1">What were the outcomes and benefits? Rich text supported.</p>
                    </div>
                    ...
                    <div class="mt-6 flex flex-wrap gap-6">
                        <label class="flex items-center cursor-pointer">
                            ...
                            <span class="ml-3 text-sm text-gray-700">Featured <span class="text-gray-400">(highlighted)</span></span>
                        </label>
                        <label class="flex items-center cursor-pointer">
            ...
            (function () {
                function initEditors() {
                    ...
                    ['challenge', 'solution', 'results'].forEach(function (id) {
