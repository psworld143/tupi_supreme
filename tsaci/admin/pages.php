...
$all_content = [];
if ($action === 'list') {
    $result = $db->query("SELECT pc.*, au.username as updated_by_name FROM page_content pc LEFT JOIN admin_users au ON pc.updated_by = au.id ORDER BY pc.page_name, pc.display_order, pc.section_name");
